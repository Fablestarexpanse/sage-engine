...
export const PLAY_THEME_DARK = {
  ...
  border: { subtle: "rgba(255,255,255,0.04)", dim: "rgba(255,255,255,0.07)", medium: "rgba(255,255,255,0.12)", accent: "rgba(167,139,250,0.25)", accentHot: "rgba(167,139,250,0.5)", danger: "rgba(239,68,68,0.4)", success: "rgba(52,211,153,0.4)" },
