...
| #  | Phase | Status |
|----|-------|--------|
| 05 | World packages and the running world ([phase-05-world-packages.md](phase-05-world-packages.md)) | done |
| 06 | Lexicon service ([phase-06-lexicon.md](phase-06-lexicon.md)) | done |
