...
class ConduitAttributes(BaseModel):
    ...
    Storage-contract twin: ``sage.state.state_types.ConduitAttributes``
    ...
    Stored values may differ for legacy rows; see sage.proficiencies.bonus.validate_chargen_conduit_allocation
...
class LeafRuntimeState(BaseModel):
    ...
    Storage-contract twin: ``sage.state.state_types.ProficiencyRow``
